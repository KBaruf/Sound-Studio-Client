        ...
        return (
          <div key={banner._id} className='flex justify-between items-center h-full px-8 pt-4'>
            ...
            <div className='w-68 text-white'>
              ...
              <button onClick={() => router.push('/product/hyper-system')} className='text-lg text-red-700 bg-white rounded-lg drop-shadow-md w-24 h-8 hover:scale-105 ease-in-out duration-300'>
                Shop Now
              </button>
            </div>
